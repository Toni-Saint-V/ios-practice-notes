...
## Практика на вечер
Выбери одну фичу и нарисуй ее dependency graph. Потом убери один лишний импорт соседней фичи через protocol или маленькую доменную модель.

Мини-челлендж: собери demo entry point для фичи с fake dependencies и проверь, сколько реальных модулей пришлось подтянуть.
